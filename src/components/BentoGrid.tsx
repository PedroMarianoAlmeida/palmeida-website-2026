    ...
    <section className="relative bg-[#0B0B0B] px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-[700px] lg:max-h-[900px]">
          ...
          <article className="lg:col-span-4 lg:row-span-2 bg-[#0B0B0B] border border-[#00A86B] rounded-3xl p-6 lg:p-8 shadow-lg hover:shadow-[0_0_30px_rgba(0,168,107,0.45)] hover:scale-[1.025] transition-all duration-300 relative overflow-hidden group order-1">
            <div className="absolute inset-0 bg-gradient-to-br from-[#00A86B]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          ...
          <article className="lg:col-span-4 bg-[#0B0B0B] border border-[#00F5FF]/70 rounded-3xl p-6 shadow-lg hover:shadow-[0_0_24px_rgba(0,245,255,0.35)] hover:scale-105 transition-all duration-300 relative overflow-hidden group order-2">
            <div className="absolute inset-0 bg-gradient-to-br from-[#00F5FF]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative z-10">
          ...
          <article className="lg:col-span-4 bg-[#0B0B0B] border border-gray-700 rounded-3xl p-6 shadow-lg hover:shadow-[0_0_20px_rgba(0,168,107,0.25)] hover:scale-105 transition-all duration-300 relative overflow-hidden group order-3">
            <div className="absolute inset-0 bg-gradient-to-br from-[#00A86B]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <div className="relative z-10">
          ...
          {/* The Lab */}
          <article className="lg:col-span-4 lg:row-span-2 bg-[#0B0B0B] border border-gray-700 rounded-3xl p-6 lg:p-8 shadow-lg hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:scale-105 transition-all duration-300 relative overflow-hidden group order-5">
            <div className="relative z-10">
          ...
          <article className="lg:col-span-2 lg:row-span-2 bg-[#0B0B0B] border border-gray-700 rounded-3xl p-6 shadow-lg hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:scale-105 transition-all duration-300 relative overflow-hidden group order-6">
            <div className="relative z-10">
              <h3 className="text-lg font-bold mb-3 text-white">
                Open Source Contributor
              </h3>
          ...
          {/* Industrial Roots */}
          <article className="lg:col-span-2 bg-[#0B0B0B] border border-gray-700 rounded-3xl p-6 shadow-lg hover:shadow-[0_0_20px_rgba(255,191,0,0.25)] hover:scale-105 transition-all duration-300 relative overflow-hidden group order-4">
            <div className="relative z-10">
              <h3 className="text-lg font-bold mb-3 text-white">
          ...
          <article className="lg:col-span-6 bg-[#0B0B0B] border border-gray-700 rounded-3xl p-6 shadow-lg hover:shadow-[0_0_18px_rgba(255,255,255,0.15)] hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group order-7">
            <div className="relative z-10">
              <h3 className="text-xl lg:text-2xl font-bold mb-3 text-white">
                Engineering Insights
              </h3>
